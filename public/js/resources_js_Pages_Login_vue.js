...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    submit: function submit() {
      ...
      var vm = this;
      axios.post('/adminlogin', this.form).then(function (response) {
  ...
  return _c(
    ...
    [
      _c("div", [
        ...
        _c(
          "form",
          { staticClass: "m-t", attrs: { role: "form", action: "index.html" } },
          [
            _c("div", { staticClass: "form-group" }, [
              _c("input", {
                ...
                attrs: { type: "email", placeholder: "Username", required: "" },
              ...
              _vm.error && _vm.error.email
                ? _c("span", [_vm._v(_vm._s(_vm.error.email[0]))])
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              ...
              _vm.error && _vm.error.password
                ? _c("span", [_vm._v(_vm._s(_vm.error.password[0]))])
                : _vm._e()
            ]),
            _vm._v(" "),
            _c(

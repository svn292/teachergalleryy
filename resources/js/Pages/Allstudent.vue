...
<div class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
			...
			<div class="ibox">
				...
				<inertia-link  class="btn btn-sm btn-primary" href="/admin/addstudent">
                       Add New
                    </inertia-link>	
						...
						<table class="table table-striped table-bordered table-hover dataTables-example" >
							...
							<tr :key="key" v-for="(item,key) in rows.data" class="gradeX2">							
								...
								<td width=140>
									...
									<inertia-link  :href="'editstudent/'+item.id" class="btn btn-primary btn-sm edit_item"  > 
...
.then((willDelete) => {
  if (willDelete) {
    this.$inertia.visit(this.appurl+'/admin/deletestudent/'+id, { method: 'delete' })
  }
});
		},
